...
<body class="bg-gray-100 m-0 p-0">
    <div class="flex min-h-screen w-full">
            ...
            <nav class="mt-6 flex flex-col min-h-96">
                ...
                <a href="{{ route('unified.message') }}"
                    ...
                    <div class="relative">
                        ...
                        <span id="messagesBadge" style="display: none;" class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full size-3 flex items-center justify-center font-bold">0</span>
                    </div>
                    <span class="menu-text transition-opacity duration-300">پیام‌ها</span>
                </a>
        ...
        <div class="flex-1 min-[658px]:mr-[63px]  w-full ">
            ...
            <ul
                ...
                <li class="relative">
                    <a href="{{ route('unified.message') }}"
                        class="lamp block py-4 text-lg text-gray-700 hover:text-blue-600">
                        پیام‌ها
                        <span id="mobileMessagesBadge" style="display: none;" class="absolute top-2 right-16 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">0</span>
                    </a>
                </li>
    ...
    <script src="{{ asset('assets/js/common/notification-system.js') }}"></script>
